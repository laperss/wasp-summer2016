...
# Add executable for WASP Project

# set header and source files
set(WASP_ARDRONE_SOURCE_FILES         
	src/autopilot/ControlNode.cpp
	src/autopilot/DroneController.cpp
	src/autopilot/KI/KILand.cpp
	src/autopilot/KI/KIAutoInit.cpp
...
set(WASP_ARDRONE_HEADER_FILES        
	...
	src/autopilot/KI/KIFlyTo.h
	src/autopilot/KI/KIProcedure.h
	src/wasp-summer2016/RunDrone.h
	src/wasp-summer2016/SubScriber.h
	src/wasp-summer2016/ArdroneNavdata.h
)


add_executable(run_drone src/wasp-summer2016/main.cpp  ${WASP_ARDRONE_SOURCE_FILES} ${WASP_ARDRONE_HEADER_FILES})
target_link_libraries(run_drone  ${catkin_LIBRARIES})
#add_dependencies(run_drone beginner_tutorials_generate_messages_cpp)

# add_executable(drone_autopilot ${AUTOPILOT_SOURCE_FILES} ${AUTOPILOT_HEADER_FILES})
# target_link_libraries(drone_autopilot ${catkin_LIBRARIES})
add_dependencies(run_drone thirdparty ${PROJECT_NAME}_gencpp ${PROJECT_NAME}_gencfg)